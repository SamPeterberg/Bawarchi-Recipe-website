...
const Contact = () => {
  return (
    <div>
      <section className="py-10 bg-gradient-to-r from-red-600 via-red-900 to-yellow-600  sm:py-16 lg:py-24 bg-no-repeat bg-cover">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">
              ...
              or just want to say hello, feel free to reach o
            </p>
          </div>
